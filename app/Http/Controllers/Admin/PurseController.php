...
class PurseController extends CommonController {
	...
	public function user_type_detail(Request $request,int $id){
	...
	public function user_type_add(Request $request){
		request()->validate([
			'name'		=> 'required',
			'alias'		=> 'required',
		]);
	...
	public function user_type_del(Request $request){
		$id = $request->input('id');
	 ...
	 * @return array
	 */
	public function purse_type(Request $request){
	...
	public function purse_type_detail(Request $request,int $id){
	...
	public function purse_type_add(Request $request){
		request()->validate([
			'name'		=> 'required',
			'alias'		=> 'required',
		]);
	...
	public function purse_type_delete(Request $request){
		$id = $request->input('id');
